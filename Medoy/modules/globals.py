...
from Medoy import *
from Medoy.helpers.adminHelpers import DEVS, WHITELIST
from Medoy.helpers.basic import edit_or_reply
from Medoy.helpers.PyroHelpers import get_ub_chats
from Medoy.utils import extract_user, extract_user_and_reason
...
def globals_init():
    try:
        ...
        sql = import_module("Medoy.helpers.SQL.gban_sql")
        sql2 = import_module("Medoy.helpers.SQL.gmute_sql")
